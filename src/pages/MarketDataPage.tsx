...
import { LineChart, Briefcase, Newspaper, Bell, BookOpen, CircleDollarSign, 
    ...
    <div className={cn("min-h-screen transition-colors", darkMode ? "dark bg-zinc-900" : "bg-white")}>
      <SidebarProvider defaultOpen={true}>
        <div className="flex min-h-screen w-full">
              ...
              <SidebarMenu>
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton 
                    ...
                    onClick={() => toast({
                      title: "Module Changed",
                      description: "Navigated to Portfolio module",
                      duration: 2000,
                    })}
                    tooltip="Portfolio"
                  >
          ...
          <SidebarInset>
            <DashboardView activeModule="market-data" darkMode={darkMode} />
          </SidebarInset>
        </div>
      </SidebarProvider>
    </div>
