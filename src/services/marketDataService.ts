import { MarketDataItem, TimeframeData, Timeframe } from '@/types/marketData';

// Generate mock data based on timeframe
const generateTimeframeData = (timeframe: Timeframe, baseValue: number = 4850, volatility: number = 0.02) => {
